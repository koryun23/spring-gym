...
create table TRAINER (id bigint not null, specialization_id bigint not null primary key DEFAULT nextval('trainer_sequence'), user_id bigint not null unique)
...
create table USERS (is_active boolean, id bigint not null primary_key DEFAULT nextval('user_sequence'), first_name varchar(255) not null, last_name varchar(255) not null, password varchar(255) not null, username varchar(255) not null)
