...
public class TrainerCreateParams {
    ...
    public TrainerCreateParams() {
    }

    public TrainerCreateParams(Long userId,
                               String firstName,
                               String lastName,
                               String username,
                               String password,
    ...
    public boolean equals(Object o) {
        ...
        TrainerCreateParams that = (TrainerCreateParams) o;
