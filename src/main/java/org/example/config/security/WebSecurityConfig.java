    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/password").hasAnyAuthority("TRAINEE", "TRAINER")
                .requestMatchers(HttpMethod.GET, "/trainees/**").hasAnyAuthority("TRAINEE", "TRAINER")
                .requestMatchers(HttpMethod.PUT, "/trainees/**").hasAuthority("TRAINEE")
                .requestMatchers(HttpMethod.DELETE, "/trainees/**").hasAuthority("TRAINEE")
                .requestMatchers(HttpMethod.GET, "/trainers/**").hasAuthority("TRAINER")
                .requestMatchers(HttpMethod.PUT, "/trainers/**").hasAuthority("TRAINER")
                .requestMatchers(HttpMethod.GET, "/trainers/unassigned-to/**").hasAuthority("TRAINEE")
                .requestMatchers(HttpMethod.GET, "/trainings/trainee/**").hasAuthority("TRAINEE")
                .requestMatchers(HttpMethod.GET, "/trainings/trainer/**").hasAuthority("TRAINER")
                .requestMatchers(HttpMethod.POST, "/trainings").hasAuthority("TRAINER")
                .requestMatchers(HttpMethod.PATCH, "/trainees/**").hasAuthority("TRAINEE")
                .requestMatchers(HttpMethod.PATCH, "/trainers/**").hasAuthority("TRAINER")
                .requestMatchers(HttpMethod.GET, "/training-types").hasAnyAuthority("TRAINEE", "TRAINER")
