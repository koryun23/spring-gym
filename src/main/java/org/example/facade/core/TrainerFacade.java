...
public interface TrainerFacade {
    ...
    RestResponse<TrainerSwitchActivationStateResponseDto> switchActivationState(
        TrainerSwitchActivationStateRequestDto requestDto);

    RestResponse<TrainerRetrievalResponseDto> retrieveTrainerByUsername(
    ...
    RestResponse<TraineeTrainerListUpdateResponseDto> updateTraineeTrainerList(
