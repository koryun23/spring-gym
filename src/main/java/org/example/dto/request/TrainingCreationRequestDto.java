...
public class TrainingCreationRequestDto {
    ...
    public boolean equals(Object o) {
        ...
        TrainingCreationRequestDto that = (TrainingCreationRequestDto) o;
    ...
    public String toString() {
        return ("TrainingCreationRequestDto{trainingId=%d, traineeId=%d, trainerId=%d, name='%s', trainingType=%s, "
